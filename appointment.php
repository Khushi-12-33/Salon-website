...
<html lang="en">
    ...
    <body>
        ...
        <div class="section-header text-center" style="margin-top: 90px;">
            ...
            <h2>Lets make an appointment</h2>
        </div>
                    ...
                    <div class="row align-items-center">
                        ...
                        <div class="col-md-8">
                            <div class="contact-form">
                                <iframe name="hidden_iframe" id="hidden_iframe" style="display: none;" onload="var submitted;if(submitted){var success=document.getElementById('successMsg');success.style.display='block';window.open('appointment.php');}else{var failure=document.getElementById('failure');failure.style.display='block';}"></iframe>
                                <div id="success successMsg">Appointment Booked.</div>
                                <div id="success failure">Unable to book appointment.</div>
                                <form name="sentMessage" id="contactForm" novalidate="novalidate" action="https://docs.google.com/forms/u/2/d/e/1FAIpQLSdGFhLF8JgjVoz9gs8y9NiN1RNL0_SJtdCcHV3j3bl_eME1bw/formResponse" onsubmit="return var submitted=true;" target="hidden_iframe">
                                    <div class="control-group">
                                        <input type="text" class="form-control" id="name" placeholder="Your Name" required="required" data-validation-required-message="Please enter your name" name="entry.1530950633"/>
                                        <p class="help-block text-danger error1"></p>
                                    </div>
                                    <div class="control-group">
                                        <input type="text" class="form-control" id="phone" placeholder="Your Phone number" required="required" data-validation-required-message="Please enter your contact number" name="entry.75230771"/>
                                        <p class="help-block text-danger error3"></p>
                                    </div>
                                    <div class="control-group">
                                        <input type="email" class="form-control" id="email" placeholder="Your Email" required="required" data-validation-required-message="Please enter your email" name="entry.728120317"/>
                                        <p class="help-block text-danger error2"></p>
                                    </div>
                                    <div class="control-group">
                                        <input type="date" class="form-control" id="date" placeholder="Appointment Date" required="required" data-validation-required-message="Please enter date" name="entry.1624592064"/>
                                        <p class="help-block text-danger"></p>
                                    </div>
                                    <div class="control-group">
                                        <input type="time" class="form-control" id="time" placeholder="Appointment Time" required="required" data-validation-required-message="Please enter time slot" name="entry.348153100"/>
                                        <p class="help-block text-danger"></p>
                                    </div>
                                    <div class="control-group">
                                        <select id="gender" class="form-control" name="entry.82461386" required="required">
                                            <option value="Male" name="entry.82461386">Male</option>
                                            <option value="Female" name="entry.82461386">Female</option>
                                            <option value="Other" name="entry.82461386">Other</option>
                                        </select>
                                        <p class="help-block text-danger"></p>
                                    </div>
                                    <div class="control-group">
                                        <input type="text" class="form-control" id="subject" placeholder="Service Details" required="required" data-validation-required-message="Please enter a service details" name="entry.691111947"/>
                                        <p class="help-block text-danger"></p>
                                    </div>
                                    <div>
                                        <button class="btn" type="submit" id="sendMessageButton">Book Appointment</button>
                                    </div>
                                </form>
                            </div>
                        </div>
        ...
        <!-- Contact Javascript -->
        <script src="form/appointment.js"></script>
